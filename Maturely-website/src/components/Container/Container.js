...
function Container() {
  ...
  function content() {
    ...
    if (module_id === "male_female_anatomy") {
      return `Unfortunately, kids are not educated about what their private parts are and how girls and boys have different private parts.As kids, according to research almost 70 percent involve in
            ...
            Girls:
            The private parts for a girl are her under-arms, her chest area (later to grow into breasts), lower abdominal organs – the vagina and butt. Most of the organs are same as that of boys except for the chest area and their vagina. Once they hit puberty (explained more in the next section), they start to grow out breasts. Breasts are a cup shaped organ made up of fatty tissues and other glands. This organ in a woman has the special functionality to produce mammary glands (milk) post pregnancy for a woman, so that she can feed her child. Over the years, this organ has been sexualised and misinterpreted by the society.Similarly, a woman’s excretory/reproductive organ has been built differently than boys. To know about how the female vaginal anatomy looks, head towards our bot or to the anatomy module.
            Boys:
            The private parts for boys are pretty much the same as girls. Despite the gender, the integrity of one’s own body remains the same. Boys after hitting their puberty do not grow out breasts. Their chest remains flat (perhaps a little more bulked up). However, their penis grows out in size. The penis is a boy’s lower abdominal frontal organ used for excretion as well as other purposes. To protect their penis as well as induce sex hormones, men also have ball shaped testicles beneath their penis.  Men and women are bound to be biologically different and that is natural. One should respect these differences and not cross their boundaries.
            `;
    }
    if (module_id === "hitting_puberty") {
      return `Puberty is when a child's body begins to develop and change as they become an adult. Girls develop breasts and start their periods. Boys develop a deeper voice and facial hair will start to appear. The average age for girls to begin puberty is 11, while for boys the average age is 12. But it's different for everyone, so don't worry if you hit puberty earlier or later. You can realise that you are going to hit puberty soon if you face these symptoms.
            ...
            boys go through a growth spurt and become taller by an average of 7 to 8cms, or around 3 inches a year, and more muscular.Talk about these changes to a guardian/parent if you feel uncomfortable. It is totally NORMAL to feel different. Hitting puberty just means you are entering a new phase in life – adulthood.
            `;
    }
